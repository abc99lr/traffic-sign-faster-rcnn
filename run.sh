...
#python test_frcnn.py --network=fcnet --path=../faster-rcnn/dataset/PNG_train/gt.txt --config_filename=fcnet_config_48.pickle
...
#python test_frcnn.py --network=zfnet --path=../faster-rcnn/dataset/PNG_train/gt.txt --config_filename=zfnet_config_8_stride.pickle
...
python test_frcnn.py --network=vgg --path=../faster-rcnn/dataset/PNG_train/gt.txt --config_filename=vgg_config_8_stride.pickle