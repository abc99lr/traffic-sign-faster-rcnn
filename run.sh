...
#python train_frcnn.py --network=zfnet --parser=simple --num_epochs=12 --epoch_length=600 --path=../faster-rcnn/dataset/PNG_train/gt.txt --config_filename=zfnet_8_config.pickle --output_weight_path='./model_frcnn_zfnet_8.hdf5'
#python test_frcnn.py --network=vgg --path=../faster-rcnn/dataset/PNG_test --config_filename=vgg_config.pickle
python train_frcnn.py --network=vgg --parser=simple --num_epochs=12 --epoch_length=600 --path=../faster-rcnn/dataset/PNG_train/gt.txt --config_filename=vgg_8_config.pickle --output_weight_path='./model_frcnn_vgg_8.hdf5'
#python test_frcnn.py --network=vgg --path=../faster-rcnn/dataset/PNG_test --config_filename=vgg_config.pickle