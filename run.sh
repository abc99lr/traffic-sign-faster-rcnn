...
python train_frcnn.py --network=simple --parser=simple --num_epochs=10 --epoch_length=600 --path=../faster-rcnn/dataset/PNG_train/gt.txt --config_filename=simple_config.pickle --output_weight_path='./model_frcnn_simple.hdf5'
