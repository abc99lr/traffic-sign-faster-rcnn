...
python train_frcnn.py --network=zfnet --parser=simple --num_epochs=12 --epoch_length=600 --path=../faster-rcnn/dataset/PNG_train/gt.txt --config_filename=zfnet_config.pickle --output_weight_path='./model_frcnn_zfnet.hdf5'
