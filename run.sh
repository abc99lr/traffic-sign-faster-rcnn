...
python train_frcnn.py --network=simple --parser=simple --num_epochs=5 --epoch_length=600 --path=../faster-rcnn/dataset/PNG_train/gt.txt --config_filename=config.pickle --output_weight_path='./model_frcnn_simple.hdf5'
